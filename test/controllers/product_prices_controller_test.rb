...
class ProductPricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_price" do
    assert_difference("ProductPrice.count") do
      post product_prices_url, params: { product_price: { effective_date: @product_price.effective_date, price: @product_price.price, product_id: @product_price.product_id } }
    end
  ...
  test "should update product_price" do
    patch product_price_url(@product_price), params: { product_price: { effective_date: @product_price.effective_date, price: @product_price.price, product_id: @product_price.product_id } }
