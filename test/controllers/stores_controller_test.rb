...
class StoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update store" do
    patch store_url(@store), params: { store: { contact_email: @store.contact_email, description: @store.description, logo_url: @store.logo_url, name: @store.name, phone: @store.phone } }
